...
public class IgmpKafkaIntegration {
   ...
   // IGMP stats event params
    ...
    private static final String IGMP_GSSQ_REQ = "igmpGssqReq";
    ...
    private static final String IGMP_GMQ_REQ = "igmpGmqReq";
    private static final String IGMP_GSQ_REQ = "igmpGsqReq";
    ...
    private JsonNode serializeStat(IgmpStatisticsEvent event) {
        ...
        igmpStatEvent.put(IGMP_GSSQ_REQ, event.subject().getIgmpGssqReq());
        igmpStatEvent.put(TOTAL_MSG_RECEIVED, event.subject().getTotalMsgReceived());
        igmpStatEvent.put(IGMP_MSG_RECEIVED, event.subject().getIgmpMsgRecived());
        igmpStatEvent.put(INVALID_IGMP_MSG_RECEIVED, event.subject().getInvalidIgmpMsgReceived());
        igmpStatEvent.put(IGMP_GMQ_REQ, event.subject().getIgmpGmqReq());
        igmpStatEvent.put(IGMP_GSQ_REQ, event.subject().getIgmpGsqReq());
        log.debug("IGMP_GSQ_REQ===" + event.subject().getIgmpGsqReq());
